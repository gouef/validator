...
func TestCompareValidate(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "Valid GreaterThen constraint (float32)",
			value:       float32(6),
			constraints: []validator.Constraint{constraints.GreaterThen{Value: 5}},
			expectErr:   false,
		},
		{
			name:        "Valid GreaterThen constraint (float64)",
			value:       float64(6),
			constraints: []validator.Constraint{constraints.GreaterThen{Value: 5}},
			expectErr:   false,
		},
		...
		{
			name:        "Valid GreaterOrEqual constraint (float32)",
			value:       float32(6),
			constraints: []validator.Constraint{constraints.GreaterOrEqual{Value: 5}},
			expectErr:   false,
		},
		{
			name:        "Valid GreaterOrEqual constraint (float64)",
			value:       float64(6),
			constraints: []validator.Constraint{constraints.GreaterOrEqual{Value: 5}},
			expectErr:   false,
		},
		{
			name:        "Valid GreaterOrEqual constraint (equal)",
			value:       5,
			constraints: []validator.Constraint{constraints.GreaterOrEqual{Value: 5}},
			expectErr:   false,
		},
		{
			name:        "Invalid GreaterOrEqual constraint (string)",
			value:       "invalid",
			constraints: []validator.Constraint{constraints.GreaterOrEqual{Value: 5}},
			expectErr:   true,
		},
		...
		{
			name:        "Invalid GreaterThen constraint (type)",
			value:       "invalid greater or equal",
			constraints: []validator.Constraint{constraints.GreaterThen{Value: 6}},
			expectErr:   true,
		},
		{
		...
		{
			name:        "Valid LessOrEqual constraint (float32)",
			value:       float32(4),
			constraints: []validator.Constraint{constraints.LessOrEqual{Value: 5}},
			expectErr:   false,
		},
		{
			name:        "Valid LessOrEqual constraint (float64)",
			value:       float64(4),
			constraints: []validator.Constraint{constraints.LessOrEqual{Value: 5}},
			expectErr:   false,
		},
		...
		{
			name:        "Valid LessThen constraint (float32)",
			value:       float32(4),
			constraints: []validator.Constraint{constraints.LessThen{Value: 5}},
			expectErr:   false,
		},
		{
			name:        "Valid LessThen constraint (float64)",
			value:       float64(4),
			constraints: []validator.Constraint{constraints.LessThen{Value: 5}},
			expectErr:   false,
		},
